...
//Class Registration - Main/Driver Class
public class Registration
{
    public static void main(String args[])
    {
        ...
        //Assume that I would like to add Course for 'Student1' object, but it's already exceeding the limitations
        Student1.registerCourse(FirstCourse);
        //Display the details of the Student again
        //A message "Course cannot be registered : (Maximum Reached)" appears in the terminal
        System.out.println(Student1.toString());
